...
export default function WalletButton() {
  ...
  return (
    <button
      ...
      className="btn-glossy px-3 py-1.5 sm:px-5 sm:py-2.5 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold text-white shadow-lg glow-purple disabled:opacity-50"
    >
      {isConnecting ? (
